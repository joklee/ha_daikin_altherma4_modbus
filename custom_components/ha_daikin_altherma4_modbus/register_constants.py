...
=======
        device_class="power",
>>>>>>> 5826f25 (Use device_class for icons and move remaining icons to icons.json)
...
HOLDING_REGISTERS = [
    ...
    SelectRegister(
        ...
        data_type=INT16,
        enum_map={0: "off", 1: "on_automatic", 2: "on_manual"},
    ...
    SelectRegister(
        ...
        data_type=INT16,
        enum_map={0: "fixed", 1: "weather_dependent"},
