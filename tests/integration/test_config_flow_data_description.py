...
pytestmark = [pytest.mark.ha, pytest.mark.config_flow]
...
def _load_config_flow_module(monkeypatch):
    ...
    content = content.replace(
        ...
        "from custom_components.ha_daikin_altherma4_modbus.modbus.modbus_client import RealModbusTcpClient",
    )
