...
from custom_components.ha_daikin_altherma4_modbus.entities.select import (
    DaikinSelect,
    async_setup_entry,
)
...
async def test_async_setup_entry_creates_selects():
    ...
    import custom_components.ha_daikin_altherma4_modbus.entities.select as sel_mod
