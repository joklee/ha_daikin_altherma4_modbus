...
def _load_sensor_module(monkeypatch):
    ...
    const_module_name = f"{package_name}.core.const"
    sensor_module_name = f"{package_name}.entities.sensor"
    common_module_name = f"{package_name}.common"
    config_utils_name = f"{package_name}.integration.config_entry_utils"
    ...
    for sub in ("entities", "core", "integration"):
