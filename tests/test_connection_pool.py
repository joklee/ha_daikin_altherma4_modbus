...
async def test_connection_pool_lock_contention_concept():
    ...
    print(f"✅ Lock contention handled successfully!")
...
async def test_connection_pool_recovery_concept():
    ...
    print(f"✅ Connection recovery working correctly!")
...
async def test_connection_pool_cache_management_concept():
    ...
    client1 = await MockRealModbusTcpClient.create("192.168.1.100", 502)
    client2 = await MockRealModbusTcpClient.create("192.168.1.100", 502)  # Same host:port
    client3 = await MockRealModbusTcpClient.create("192.168.1.101", 502)  # Different host
    
    print(f"   Created 3 clients (2 same host, 1 different)")
    ...
    client5 = await MockRealModbusTcpClient.create("192.168.1.100", 502)
    
    print(f"   Created 2 new clients after cache clear")
    ...
    print(f"   Cache Population: ✅ Working")
    print(f"   Cache Clearing: ✅ Working")
    print(f"   Post-Clear Operations: ✅ Working")
    
    print(f"✅ Cache management working correctly!")
...
async def test_connection_pool_performance_metrics():
    ...
    assert operations_per_second > 100, f"Performance too low: {operations_per_second:.1f} ops/s"
