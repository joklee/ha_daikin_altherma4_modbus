...
def test_file_structure():
    ...
    required_files = [
        ...
        "custom_components/ha_daikin_altherma4_modbus/core/const.py",
        "custom_components/ha_daikin_altherma4_modbus/modbus/mock_client.py",
        "custom_components/ha_daikin_altherma4_modbus/core/data_manager.py",
        "custom_components/ha_daikin_altherma4_modbus/integration/coordinator.py",
        "custom_components/ha_daikin_altherma4_modbus/entities/sensor.py",
        "custom_components/ha_daikin_altherma4_modbus/modbus/client_interface.py",
    ]
